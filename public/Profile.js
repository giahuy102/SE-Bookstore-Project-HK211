            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.book.picture,
                expression: "book.picture"
              }
            ],
            staticClass: "row-input",
            attrs: { type: "text", size: "80", disabled: _vm.locking },
            domProps: { value: _vm.book.picture },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.book, "picture", $event.target.value)
              }
            }
          })
        ])
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "row filling-one-row" }, [
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    {
                      attrs: {
                        to: { name: "updateBook", params: { bookID: item.id } }
                      }
                    },
                    [
                  ...
                  _c(
                    ...
                    {
                      attrs: {
                        to: { name: "bookInfo", params: { bookID: item.id } }
                      }
                    },
                    [
                      _c("button", { staticClass: "btn icon" }, [
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { staticClass: "col-2" }, [_vm._v("Price")]),
        _vm._v(" "),
...
/***/ "./resources/js/assets/search-icon.png":
/*!*********************************************!*\
  !*** ./resources/js/assets/search-icon.png ***!
  \*********************************************/
/*! no static exports found */
