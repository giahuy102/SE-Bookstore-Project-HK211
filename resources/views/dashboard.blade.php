  ...
  <div class="inner-container">
    <div class="button-gr text-center pb-2">
      <div class="btn-group" role="group" aria-label="Basic example">
        <button type="button" class="btn btn-primary" style="border-radius: 45% 0 0 45%; width:4.5rem;border: 1px solid #0084B4">Day</button>
        <button type="button" class="btn" style="width:4.5rem; border: 1px solid #0084B4">Week</button>
        <button type="button" class="btn" style="border-radius: 0 45% 45% 0;width:4.5rem; border: 1px solid #0084B4">Month</button>
      </div>
    </div>
