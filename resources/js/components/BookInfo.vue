  ...
  <div>
      ...
      <div class="container filling-all-info">
            ...
            <div class="row one-row-field">
                ...
                <div class="col text-left"><input class="row-input" v-model="book.id" type="text" size="80" :disabled="locking"></div>
            </div>
            ...
            <div class="row one-row-field">
                ...
                <div class="col text-left"><input class="row-input" v-model="book.category" type="text" size="80" :disabled="locking"></div>
            </div>
            <div class="row one-row-field">
            ...
            <div class="row one-row-field">
                ...
                <div class="col text-left"><input class="row-input" v-model="book.picture" type="text" size="80" :disabled="locking"></div>
            </div>
            <div class="row one-row-field">
