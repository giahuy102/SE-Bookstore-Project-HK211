<template>
  <div class="container-custom row">
    <div id="filter" class="col-3">
      <h3>Sort by</h3>
      <ul>
        <li class="content-filter" @click="sortPriceLowToHigh">
          Price: Low to High
        </li>
        <li class="content-filter" @click="sortHighToLow">
          Price: High to Low
        </li>
        <li class="content-filter" @click="sortViewHighToLow">
          Customer review
        </li>
...
export default {
  ...
  mounted() {
    ...
    if (this.books.length == 0) {
      this.category = "No result found";
    } else if (this.books.length == 1) {
      this.category = "1 result found";
    } else this.category = this.books.length + " results found";
  },
};
</script>
